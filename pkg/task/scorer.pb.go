...
func (*ScorerRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_scorer_6024a44f7c181c1a, []int{0}
}
...
func (*Score) Descriptor() ([]byte, []int) {
	return fileDescriptor_scorer_6024a44f7c181c1a, []int{1}
}
...
func (*ScorerReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_scorer_6024a44f7c181c1a, []int{2}
}
...
func (this *Score) GoString() string {
	...
	s = append(s, "SiderID: "+fmt.Sprintf("%#v", this.SiderID)+",\n")
...
func (m *Score) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.SiderID) > 0 {
		dAtA[i] = 0xa
		i++
		i = encodeVarintScorer(dAtA, i, uint64(len(m.SiderID)))
		i += copy(dAtA[i:], m.SiderID)
	}
	if m.Score != 0 {
		dAtA[i] = 0x11
		i++
	...
	if len(m.FirstName) > 0 {
		dAtA[i] = 0x1a
		i++
		i = encodeVarintScorer(dAtA, i, uint64(len(m.FirstName)))
		i += copy(dAtA[i:], m.FirstName)
	}
	if len(m.LastName) > 0 {
		dAtA[i] = 0x22
		i++
		i = encodeVarintScorer(dAtA, i, uint64(len(m.LastName)))
...
func NewPopulatedScore(r randyScorer, easy bool) *Score {
	this := &Score{}
	this.SiderID = string(randStringScorer(r))
	this.Score = float64(r.Float64())
	if r.Intn(2) == 0 {
		this.Score *= -1
	}
	this.FirstName = string(randStringScorer(r))
	this.LastName = string(randStringScorer(r))
	if !easy && r.Intn(10) != 0 {
	}
	return this
}
...
func (this *Score) String() string {
	...
	s := strings.Join([]string{`&Score{`,
		`SiderID:` + fmt.Sprintf("%v", this.SiderID) + `,`,
...
func (m *Score) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SiderID", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.SiderID = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 2:
			if wireType != 1 {
...
func init() { proto.RegisterFile("scorer.proto", fileDescriptor_scorer_6024a44f7c181c1a) }

var fileDescriptor_scorer_6024a44f7c181c1a = []byte{
	// 323 bytes of a gzipped FileDescriptorProto
	,
}
